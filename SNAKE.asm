...
chose_diffrent_num:			;שורה
	...
	mov es, ax
	mov ax, [es:6Ch]
	and al, 00001111b		; יצירת המספר 0-16
	mov dl , al				;אמנם לא מכסה את כל השורות, אבל כרגע 16 שורות מספיק
...
chose_again:
	...
	mov es, ax
	mov ax, [es:6Ch]
	and al, 00000011b		;יצרית המספר

	
	add dl, al				;להפוך ל 0-67
							;אמנם לא מכסה את כל הטורים, אבל כרגע 67 תורים זה מספיק
